-- Production Seed Data for Hans Restaurant App
...
DO $$
BEGIN
    RAISE NOTICE 'Production seed data inserted successfully for Joschi Pizza Bistro';
    RAISE NOTICE 'Organization: Joschi Pizza Bistro (joschi-pizza-bistro)';
    RAISE NOTICE 'You can now create a user account and link it to this organization';
END $$;
